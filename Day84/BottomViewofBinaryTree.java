...
class Solution {
    ...
    public ArrayList<Integer> bottomView(Node root) {
        ...
        while (!q.isEmpty()) {
            ...
            map.put(curr.hd, curr.node.data); // Overwrite the value in the map for the current horizontal distance.
            // As we perform level-order traversal, the last node encountered at each horizontal distance will be stored in the map.
        ...
        return res; // Return the list containing the bottom view of the binary tree
    }
